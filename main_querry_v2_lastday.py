...
def main():
    ...
    train['question1_porter'] = train['question1'].values.astype(str).apply(lambda x:stem_str(x.lower(),porter))
    test['question1_porter'] = test['question1'].values.astype(str).apply(lambda x:stem_str(x.lower(),porter))
    
    train['question2_porter'] = train['question2'].values.astype(str).apply(lambda x:stem_str(x.lower(),porter))
    test['question2_porter'] = test['question2'].values.astype(str).apply(lambda x:stem_str(x.lower(),porter))
