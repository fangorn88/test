...
model = KNeighborsClassifier(n_neighbors=512, weights='uniform', algorithm='auto', leaf_size=30, 
...
np.savetxt("stnet/train_stacker_knn_n0.5.csv", train_stacker, delimiter=",", fmt='%.6f')
...
np.savetxt("stnet/test_stacker_knn_n0.5.csv", pred_nn, delimiter=",", fmt='%.6f')
