...
model = GradientBoostingClassifier(loss='deviance', learning_rate=0.1, n_estimators=500, subsample=0.75, 
                                    criterion='friedman_mse', min_samples_split=4, max_depth=4, max_features="sqrt", 
...
np.savetxt("stnet/train_stacker_gbm_n.csv", train_stacker, delimiter=",", fmt='%.6f')
...
np.savetxt("stnet/test_stacker_gbm_n.csv", pred_nn, delimiter=",", fmt='%.6f')
