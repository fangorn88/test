...
earlyStopping=callbacks.EarlyStopping(monitor='loss', patience = 0, verbose=0, mode='auto')
...
np.savetxt("stnet/train_stacker_reg_nn_n4.csv", train_stacker, delimiter=",", fmt='%.6f')
...
np.savetxt("stnet/test_stacker_reg_nn_n4.csv", pred_nn, delimiter=",", fmt='%.6f')
