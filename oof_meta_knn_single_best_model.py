...
model = KNeighborsClassifier(n_neighbors=1024, weights='uniform', algorithm='auto', leaf_size=30, 
...
np.savetxt("stnet/train_stacker_knn_meta_1k_n.csv", train_stacker, delimiter=",", fmt='%.6f')
...
np.savetxt("stnet/test_stacker_knn_meta_1k_n.csv", pred_nn, delimiter=",", fmt='%.6f')
